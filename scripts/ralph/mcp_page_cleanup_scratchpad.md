...
- [ ] 01. Build a failure classifier: process-crash (-6 SIGABRT / -11 SEGV / -9 OOM), start-timeout, DNS(-2), conn-refused, HTTP 4xx/5xx, auth 401 → {clean client message, stable client error code, correlation id}.
