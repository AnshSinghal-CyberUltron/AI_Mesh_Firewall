...
- [ ] C0. Join hive; read docs/mcp/PARALLEL_CLAIMS.md + mcp-parallel/claims. Only touch files in the
...
- [ ] 1. Playwright MCP: log in, open MCPConnectorPanel → register Linear via STDIO; capture the TWO
...
- [ ] 19. Re-run P1 repros → all four UI bugs gone; re-run P4 verification 3× (in-process + live).
       When P1–P6 all [ ] AND integration green, output <promise>COMPLETE</promise>.
