...
description: 'Production-grade investigation and implementation workflow for reliability, UX correctness, and cross-layer validation. Use when debugging incidents, fixing brittle behavior, validating frontend-backend consistency, or proving real user workflow correctness with live checks.'
argument-hint: 'Issue query, failure symptom, or workflow to investigate'
user-invocable: true
---
