...
export const DEFAULT_FIREWALL_CONFIG = {
  ...
  ragRedactionEnabled: false,
  ragTier2Enabled: false,
...
export function apiToFrontend(data) {
  return {
    ...
    ragRedactionEnabled: data.rag_redaction_enabled ?? DEFAULT_FIREWALL_CONFIG.ragRedactionEnabled,
    ragTier2Enabled: data.rag_tier2_enabled ?? DEFAULT_FIREWALL_CONFIG.ragTier2Enabled,
...
export function frontendToApi(config) {
  return {
    ...
    rag_redaction_enabled: config.ragRedactionEnabled,
    rag_tier2_enabled: config.ragTier2Enabled,
