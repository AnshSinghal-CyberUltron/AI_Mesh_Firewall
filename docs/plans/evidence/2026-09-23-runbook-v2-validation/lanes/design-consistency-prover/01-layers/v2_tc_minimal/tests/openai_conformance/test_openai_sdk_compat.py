...
# GW01: D4 (models.retrieve) and D5 (typed responses stream) are strict must-pass.
# Remaining xfail(strict=True) cells in the phase2 modules stay as recorded v1 defects.
