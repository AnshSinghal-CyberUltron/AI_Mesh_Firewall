...
## ASK-ONLY EXECUTION MODE (STRICT)

1. Do not execute code or terminal commands.
2. Do not edit files or apply patches.
3. Do not run tasks, tests, or browser automation.
4. Use questions, reasoning, and guidance only.
5. Always provide actionable next commands for the user to run manually when runtime checks are needed.
