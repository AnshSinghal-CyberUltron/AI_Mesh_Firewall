...
- qualified: 3446 (28.72 req/s; dispositions ['ALLOW', 'FLAG', 'REDACT'], source v1)
- infra errors (the error-budget gate): 8554 (rate 0.7128333333333333); reasons: {'incomplete': 8553, 'disposition_missing': 7856, 'stage_auth_missing': 7856, 'stage_kill_switch_missing': 7856, 'stage_rate_limit_missing': 7856, 'stage_policy_missing': 7856, 'stage_input_scan_missing': 7856, 'stage_model_routing_missing': 7856, 'stage_model_input_missing': 7856, 'stage_model_output_missing': 7856, 'stage_output_guardrail_missing': 7856, 'timeout': 5202, 'content_mismatch': 5195, 'unjoined': 3351, 'http_422': 1845, 'http_503': 1506}
...
- loadgen CPU (measurement phase): [{'dir': '/tmp/claude-1872320012/-home-contact-cyberultron-com-AI-Mesh-Firewall/1b4d4994-cf08-4d34-a6cb-54fd36f36877/scratchpad/evidence/v1-bench/runs/OVL-r100/lg-v1ready', 'samples': 120, 'busy_max': 5.757260419305766, 'busy_mean': 2.22, 'machine': 'c4-standard-8', 'zone': 'asia-south1-c'}]
- provider CPU: {'samples': 248, 'busy_max': 13.4965745083673, 'busy_p95': 7.057557373797774}
- completeness: [{'dir': '/tmp/claude-1872320012/-home-contact-cyberultron-com-AI-Mesh-Firewall/1b4d4994-cf08-4d34-a6cb-54fd36f36877/scratchpad/evidence/v1-bench/runs/OVL-r100/lg-v1ready', 'scheduled': 12500, 'recorded': 12500, 'interrupted': False}]
