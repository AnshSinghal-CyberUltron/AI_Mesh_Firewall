# Harness analysis (sut, policy={'blocks_total': 393, 'expected_blocks': 0, 'false_positive_blocks': 393, 'other_blocks': 0, 'benign_offered': 15000, 'false_positive_rate': 0.0262, 'policy_misses': 0, 'latency_client_total_ms': {'policy_block_fp': {'n': 393, 'min': 12.6123, 'p50': 13.6636, 'p90': 14.1439, 'p99': 14.8713, 'p999': 15.663, 'max': 15.663, 'mean': 13.656}}, 'block_rule': {'statuses': [400, 403, 422, 451], 'envelope_re': '(?i)content_filter|content_polic|polic(y|ies)_|blocked|block_|guard|violation|unsafe|threat'}}) — FAIL
...
- qualified: 14607 (48.69 req/s; dispositions ['ALLOW', 'FLAG', 'REDACT'], source auto)
- infra errors (the error-budget gate): 0 (rate 0.0); reasons: {}
- policy stratum (not qualified, not infra errors): expected blocks 0, FALSE-POSITIVE blocks 393 of 15000 benign (FP rate 0.0262), other blocks 0, policy misses 0
- policy cohort latency policy_block_fp (client total ms): n=393 p50=13.6636 p90=14.1439 p99=14.8713 p99.9=15.663 max=15.663 mean=13.656
- safety failures: 0 {}
