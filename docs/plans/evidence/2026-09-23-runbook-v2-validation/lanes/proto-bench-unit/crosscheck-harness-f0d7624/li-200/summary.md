# Harness analysis (sut, policy={'blocks_total': 1054, 'expected_blocks': 0, 'false_positive_blocks': 1054, 'other_blocks': 0, 'benign_offered': 60000, 'false_positive_rate': 0.017566666666666668, 'policy_misses': 0, 'latency_client_total_ms': {'policy_block_fp': {'n': 1054, 'min': 4.4704, 'p50': 11.0719, 'p90': 14.1559, 'p99': 16.753, 'p999': 17.7219, 'max': 17.959, 'mean': 10.9492}}, 'block_rule': {'statuses': [400, 403, 422, 451], 'envelope_re': '(?i)content_filter|content_polic|polic(y|ies)_|blocked|block_|guard|violation|unsafe|threat'}}) — FAIL
...
- qualified: 58946 (196.49 req/s; dispositions ['ALLOW', 'FLAG', 'REDACT'], source auto)
- infra errors (the error-budget gate): 0 (rate 0.0); reasons: {}
- policy stratum (not qualified, not infra errors): expected blocks 0, FALSE-POSITIVE blocks 1054 of 60000 benign (FP rate 0.017566666666666668), other blocks 0, policy misses 0
- policy cohort latency policy_block_fp (client total ms): n=1054 p50=11.0719 p90=14.1559 p99=16.753 p99.9=17.7219 max=17.959 mean=10.9492
- safety failures: 0 {}
