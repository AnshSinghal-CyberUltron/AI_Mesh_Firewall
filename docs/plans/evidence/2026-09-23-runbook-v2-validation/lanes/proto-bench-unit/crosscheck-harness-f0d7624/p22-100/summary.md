# Harness analysis (sut, policy={'blocks_total': 529, 'expected_blocks': 0, 'false_positive_blocks': 529, 'other_blocks': 0, 'benign_offered': 30000, 'false_positive_rate': 0.017633333333333334, 'policy_misses': 0, 'latency_client_total_ms': {'policy_block_fp': {'n': 529, 'min': 4.1595, 'p50': 9.637, 'p90': 12.5347, 'p99': 15.0314, 'p999': 19.2876, 'max': 19.2876, 'mean': 9.4942}}, 'block_rule': {'statuses': [400, 403, 422, 451], 'envelope_re': '(?i)content_filter|content_polic|polic(y|ies)_|blocked|block_|guard|violation|unsafe|threat'}}) — FAIL
...
- qualified: 29278 (97.59 req/s; dispositions ['ALLOW', 'FLAG', 'REDACT'], source auto)
- infra errors (the error-budget gate): 193 (rate 0.0064333333333333334); reasons: {'http_503': 193, 'incomplete': 193, 'unjoined': 193, 'disposition_missing': 193, 'stage_canon_missing': 193, 'stage_det_missing': 193, 'stage_sem_missing': 193, 'stage_resolve_missing': 193, 'stage_dispatch_missing': 193, 'stage_out_missing': 193, 'stage_audit_missing': 193}
- policy stratum (not qualified, not infra errors): expected blocks 0, FALSE-POSITIVE blocks 529 of 30000 benign (FP rate 0.017633333333333334), other blocks 0, policy misses 0
- policy cohort latency policy_block_fp (client total ms): n=529 p50=9.637 p90=12.5347 p99=15.0314 p99.9=19.2876 max=19.2876 mean=9.4942
- safety failures: 0 {}
