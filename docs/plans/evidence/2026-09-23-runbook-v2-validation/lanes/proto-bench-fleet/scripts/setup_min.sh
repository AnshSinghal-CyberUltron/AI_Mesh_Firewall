...
for n in rv-pbf-edge-1 rv-pbf-redis-1 rv-pbf-lg-1 rv-pbf-lg-2 rv-pbf-lg-3 rv-pbf-prov-1; do
...
for n in rv-pbf-unit-2; do (wait_ssh $n && rssh $n 'echo "$(hostname -s) $(nproc) $(nvidia-smi -L | wc -l)gpu"') & done; wait
...
EDGE=10.146.0.10; P1=10.146.0.8; P2=10.146.0.6; R=10.146.0.13; LGS="10.146.0.11 10.146.0.12 10.146.0.9"; UNITS="10.146.0.2"
