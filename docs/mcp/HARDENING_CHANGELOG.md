...
- **RESIDUAL:** a secret SPLIT ACROSS content-array items (reconstructed only if a client concatenates blocks without a separator) is a related lower-confidence, client-concat-dependent vector — noted for a future item.
