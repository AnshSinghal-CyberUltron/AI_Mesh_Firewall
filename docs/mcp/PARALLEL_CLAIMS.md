...
| cursor-ralph-iter32 | `services/mcp-broker/sandbox-image/agent/sse_manager.py`, `services/mcp-broker/sandbox-image/agent/upstream_manager.py`, `services/mcp-broker/sandbox-image/agent/tests/test_upstream_proxy.py`, `services/mcp-broker/sandbox-image/agent/tests/test_rpc_unified.py`, `mcp-parallel/findings/p4-13/RECHECK_ITER32.md`, `docs/mcp/PARALLEL_CLAIMS.md`, `.cursor/ralph/scratchpad.md`, `scripts/ralph/mcp_progress.md`, `mcp-parallel/claims/cursor-ralph-iter32-P4.13.claim` | P4.13/P6.18 iter32 — SSE reader + stale session agent fix | 2026-07-02T12:55:00Z | released |

| cursor-ralph-iter33 | `scripts/mcp_ws_everything_stub.mjs`, `scripts/mcp_transport_stubs_up.sh`, `mcp-parallel/findings/p4-13/RECHECK_ITER33.md`, `docs/mcp/PARALLEL_CLAIMS.md`, `.cursor/ralph/scratchpad.md`, `scripts/ralph/mcp_progress.md`, `mcp-parallel/claims/cursor-ralph-iter33-P4.13.claim` | P4.13/P6.18 iter33 — ws stub prep + gateway ws gap recheck | 2026-07-02T13:15:00Z | released |

| cursor-ralph-iter34 | `mcp-parallel/findings/p4-13/RECHECK_ITER34.md`, `docs/mcp/PARALLEL_CLAIMS.md`, `.cursor/ralph/scratchpad.md`, `scripts/ralph/mcp_progress.md`, `mcp-parallel/claims/cursor-ralph-iter34-P4.13.claim` | P4.13/P6.18 iter34 — ws blockers recheck + 3-transport verify | 2026-07-02T13:45:00Z | released |
...
| cursor-ralph-iter38 | `mcp-parallel/findings/p4-13/RECHECK_ITER38.md`, `docs/mcp/PARALLEL_CLAIMS.md`, `.cursor/ralph/scratchpad.md`, `scripts/ralph/mcp_progress.md`, `mcp-parallel/claims/cursor-ralph-iter38-P4.13.claim` | P4.13/P6.18 iter38 — URLField recheck + 3-transport ROUNDS=3 | 2026-07-02T16:00:00Z | released |

| cursor-ralph-iter39 | `control/ai_mesh_control/mcp_connector/models.py`, `control/ai_mesh_control/mcp_connector/migrations/0015_mcpserverregistration_url_charfield.py`, `mcp-parallel/findings/p4-13/RECHECK_ITER39.md`, `docs/mcp/PARALLEL_CLAIMS.md`, `.cursor/ralph/scratchpad.md`, `scripts/ralph/mcp_progress.md`, `mcp-parallel/claims/cursor-ralph-iter39-P4.13.claim` | P4.13/P6.18 iter39 — URLField CharField fix (cross-seam) + 4/4 verify | 2026-07-02T17:00:00Z | released |
...
- Cursor agents: `cursor-ralph-iter39` (iter 39), `cursor-ralph-iter38` (iter 38), `cursor-ralph-iter37` (iter 37), `cursor-ralph-iter36` (iter 36), `cursor-ralph-iter35` (iter 35), `cursor-ralph-iter34` (iter 34), `cursor-ralph-iter33` (iter 33), `cursor-ralph-iter32` (iter 32), `cursor-ralph-iter31` (iter 31), `cursor-ralph-iter30` (iter 30), `cursor-ralph-iter28` (iter 28), `cursor-ralph-iter27` (iter 27), `cursor-ralph-iter26` (iter 26), `cursor-ralph-iter1` (iter 1)

| claude-mcp-page-cleanup | MCP page (firewall-1-4) frontend (`MCPConnectorPanel.jsx`, `MCPScanControlMatrix.jsx`, `PolicyManagementPanel.jsx` + module-1.4 slices) + MCP error/state backend (`gateway/ai_mesh_gateway/mcp_proxy.py`, `mcp_stdio_adapter.py`, `control/.../mcp_connector/views.py`), `docs/mcp/MCP_PAGE_CHANGELOG.md`, `.cursor/rules/mcp-page-changelog.mdc`, `scripts/ralph/mcp_page_cleanup_scratchpad.md`, `mcp-parallel/claims/claude-mcp-page-cleanup-C0.claim` | clean errors + stuck-state + redactions + banner + aligned/responsive 1.4 page | 2026-07-03T06:30:00Z | active |
